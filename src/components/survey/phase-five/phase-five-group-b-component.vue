            ...
            <div class="row">
                <div class="col">
                    <div class="p-3 mb-2 bg-primary bg-gradient text-white shadow rounded">
                        ...
                        following questions.
                        Please also feel free to give us any further information or thoughts via the free text field.
                        Thank you very
                    ...
                    <form>
                        <div class="shadow-lg p-3 mb-5 bg-body-tertiary rounded">
                            <div class="mb-3">
                                <label for="phase5-q1" class="form-label">Would you say that the table representation of
                                    the
                                    data helped you to answer the questions? Answer on a scale from 1 to 5 where 5 is
                                    helped me a lot and
                                    1 is doesnt helped me.</label>
                                <!--    <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">-->
                                <div class="range">
                                    <input type="range" class="form-range" min="1" max="5" id="phase5-q1" v-model="q1"/>
                                </div>
                        ...
                        <div class="shadow-lg p-3 mb-5 bg-body-tertiary rounded">
                            <div class="mb-3">
                                <label for="phase5-q1" class="form-label">Could you imagine that other forms of
                                    presentation
                                    could have improved their understanding? Answer on a scale from 1 to 5 where 5 is
                                    means "Others would
                                    fit better" and 1 is "My form of representation was very suitable".</label>
                                <div class="range">
                                    <input type="range" class="form-range" min="1" max="5" id="phase5-q1" v-model="q2"/>
                                </div>
                        ...
                        <div class="shadow-lg p-3 mb-5 bg-body-tertiary rounded">
                            <div class="mb-3">
                                <label for="phase5-q1" class="form-label">Did you tend to give your answers with the
                                    ...
                                    "very sure/convinced".</label>
                                <div class="range">
                                    <input type="range" class="form-range" min="1" max="5" id="phase5-q1" v-model="q3"/>
                                </div>
                        ...
                        <div class="shadow-lg p-3 mb-5 bg-body-tertiary rounded">
                            <div class="mb-3">
                                <label for="phase5-q1" class="form-label">After going through this study, do you feel
                                    that
                                    you can better understand the decision-making of an AI? Answer this question on the
                                    scale below, where
                                    1 means "definitely not" and 5 means "definitely".</label>
                                <div class="range">
                                    <input type="range" class="form-range" min="1" max="5" id="phase5-q1" v-model="q4"/>
                                </div>
                                <span class="badge rounded-pill text-bg-primary">{{ this.q4 }}</span>
                            </div>
                        </div>
                        <div class="mb-5">
                            <a class="btn btn-primary btn-lg px-4" v-on:click="send_phase_five_results">Submit and
                                Finish Survey</a>
                        </div>
                    </form>
                </div>
